...
class BigDataset(Dataset):
    ...
    def __init__(self, data_root, pipeline, test_mode=False, file_client_args=dict(backend='disk')):
        self.data_root = data_root
        self.test_mode = test_mode
        if not self.test_mode:
            warnings.warn("BigDataset initialized without test_mode=True; this is only for testing datasets.")
