...
def main():
    ...
    model_configs = [
        ...
        # You can add Mask RCNN or MobileNetV3 here if you like:
        # {
        #     "model_type": "maskrcnn",
        #     "model_name": "Mask RCNN ResNet50",
        #     "model_path": "/home/sprice/RQ/maskrcnn/final_mask_rcnn_model.pth",
        # },
        # {
        #     "model_type": "mobilenetv3",
        #     "model_name": "MobileNetV3-Seg",
        #     "model_path": "/home/sprice/RQ/mobilenetv3/seg_model.pth",
        # },
    ]
    ...
    # 3) Load SegRefiner (only once, if you plan to refine each model’s masks)
    ...
    for config in model_configs:
        ...
        for img_path in image_paths:
            ...
            for mask in listOfMasks:
                # Some YOLO flows might give [0..255], ensure to threshold
            ...
            # -------------------------------------------------------
            # 5-B) YOLO+SAM (or Model+SAM) => if you want to refine
            #     *If you want to skip for non-YOLO, you could condition
            #      on model_type == 'yolo'. Here we do it for all if possible.
            # -------------------------------------------------------
            # If you only want to do SAM on YOLO:
            # if model_type == 'yolo':
            ...
            # -------------------------------------------------------
            # 5-C) Model+SegRefiner => refine each mask
            # -------------------------------------------------------
            ...
            # -------------------------------------------------------
            # Optional Visualization (wrap in try/except)
            # -------------------------------------------------------
            try:
                visualize_segmentations(
                    image_path=img_path,
