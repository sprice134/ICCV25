...
def main():
    ...
    for config in model_configs:
        ...
        for img_path in image_paths:
            ...
            print('num_points=4')
            print('ignore_border_percentage=5')
            print('algorithm="Voronoi"')
            print('use_mask_input=False')
            print('box_expansion_rate=0.9')
            print('mask_expansion_rate=0.0')
            print('-'*30)
    ...
    # -------------------------------------------------------
    csv_filename = os.path.join(output_dir, "evaluation_metrics_testingPickleV2_box1_nomask.csv")
    if results:
